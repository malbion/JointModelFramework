...
\section{Introduction}
    ...
    % DBS: Chu2015 above is: https://doi.org/10.1890/14-1741.1
...
%, i.e. when elements are observed to co-occur enough times and at varying densities such that the effect of one element on the performance of the other can be reliably estimated via regression. Conversely, the interaction effect of element $j$ on element $i$ is is deemed unidentifiable when there are none or too few measures of the performance of $i$ in the presence of varying densities of $j$. 
    ...
    % DBS: Why do we say "reciprocal" below?
    \paragraph{}
    ...
    % DBS: refs needed for what I've added above are:
    % Stouffer2022: https://doi.org/10.1101/2021.11.10.467010
    % Skwara2022: https://doi.org/10.1101/2022.05.12.491213
...
\section{Results}
    ...
    % DBS: I think we need to add % median competitive and % median facilitative.
...
\section{Figures}
    ...
    %DBS: Why doesn't the shading for facilitation cover from 0 to the left-most limit of the x-axis? This seems like something I should have noticed before!
