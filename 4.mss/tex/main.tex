...
Taken together, realised and unrealised interaction estimates are then used to populate community interaction matrices for the system which quantify the pairwise effects of all neighbours $j$ on all focal elements $i$. 

    \subsection{Data requirements}

    \textbf{Rewrite below according to Allesina comments}
