...
Taken together, realised and unrealised interaction estimates are then used to populate community interaction matrices for the system that quantify the pairwise effects of all neighbours $j$ on all focal elements $i$. 
