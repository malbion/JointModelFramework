...
\section{Results}
    ...
    Of the 484 focal x focal interactions, 85\% were estimated using the IFM and 15\% using the REM. Including non-focal neighbours, the number of interactiosn to be estimated was 1144 and 60\% were estimated by the REM.
