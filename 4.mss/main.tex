...
\title{Estimating interaction matrices for diverse, horizontal communities}
...
% Submit to Nature Methods - very short abstract, 

    Network theory allows us to understand complex systems by evaluating how their constituent components interact with one another. Estimating these interactions from empirical data can be difficult however, because the number of potential interactions increases non-linearly as more components are included in the system, and not all interactions may be observed when some components are rare. We present a novel modelling framework which estimates observed and unobserved interactions in diverse horizontal communities from measures of individual component performance in the absence and presence of their interaction partners. We apply this framework to an ecological dataset of an annual widlfower community 
...
\section{Methods}
    ...
    \subsection{Integrating species-level differences in demographic rates / Integrating interaction strengths into models of population dynamics}
    	...
    	\paragraph{}
        In both cases, an established population dynamic model ... This step is illustrated in our case study below, where an annual plant population dynamic model is used to transform effects on wildfower seed production (the measured proxy for lifetime reproductive success) into effects on ...., and include species-specific estimates of seed germination and surival rates. 
