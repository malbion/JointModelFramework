...
\paragraph{}
    ...
    We then applied bootstrap sampling from each resulting interaction strength distribution to create 1000 samples of the community interaction matrix. The following results are given as averages over those 1000 samples 
